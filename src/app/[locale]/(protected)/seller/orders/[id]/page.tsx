...
import { getSellerOrder } from '@/lib/orders/actions';
...
export default async function SellerOrderDetailPage({
    ...
    return <SellerOrderDetailContent order={order} locale={locale} />;
}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="text-gray-900 font-medium">
                            {(order.buyer as { full_name?: string } | null)?.full_name || 'Buyer'}
                        </p>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">{t('orders.collectOnDelivery')}</p>
                    </div>
                </div>
            </div>
        </div>
